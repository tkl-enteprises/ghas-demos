...
| [`docs/screenshots/02-push-protection-settings.png`](docs/screenshots/02-push-protection-settings.png) | 4 — Secret Scanning + Push Protection | Repo `Settings → Code security → Secret scanning` showing the push-protection toggle on. |
| [`docs/screenshots/06-secret-scanning-default-empty.png`](docs/screenshots/06-secret-scanning-default-empty.png) | 4 — Secret Scanning + Push Protection | `Security → Secret scanning` **Default** tab showing "No secrets found" — illustrates AI suppression on committed canaries. |
| [`docs/screenshots/06-secret-scanning-generic-ai.png`](docs/screenshots/06-secret-scanning-generic-ai.png) | 4 + 5 — Secret scanning / Custom patterns | `Security → Secret scanning` **Generic** tab — the AI classifier firing on `hunter2_FAKE_*`-style password assignments. |
| [`docs/screenshots/03-dependabot-alerts.png`](docs/screenshots/03-dependabot-alerts.png) | 6 — Dependabot / Supply Chain | `Security → Dependabot` alerts list across Flask, Jinja2, Werkzeug, urllib3, requests, PyYAML, cryptography. |
| [`docs/screenshots/03-dependabot-prs-list.png`](docs/screenshots/03-dependabot-prs-list.png) | 6 — Dependabot / Supply Chain | Pull requests tab filtered to `app/dependabot` — the seven open pip security-update PRs. |
| [`docs/screenshots/03-dependabot-pr-detail.png`](docs/screenshots/03-dependabot-pr-detail.png) | 6 — Dependabot / Supply Chain | A Flask-bump security-update PR with CVE annotation, release notes, and compatibility score. |
| [`docs/screenshots/05-custom-codeql-rule-list.png`](docs/screenshots/05-custom-codeql-rule-list.png) | 3 — Custom CodeQL Queries | Code-scanning alerts filtered to rule `py/tkl/hardcoded-debug-true` — proves precision (`bypass.py` absent) and recall (`target.py` present). |
| [`docs/screenshots/05-custom-codeql-alert-detail.png`](docs/screenshots/05-custom-codeql-alert-detail.png) | 3 — Custom CodeQL Queries | Alert detail for the custom-query finding — `@id`, `@kind`, source location. |
