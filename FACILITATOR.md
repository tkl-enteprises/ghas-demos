...
- Reinforces the "CodeQL is just an engine — the queries are the product" mental model from lesson 3.
...
**How to demo (≤ 3 minutes, slot anywhere after lesson 3):**
...
**When to skip:** if your audience cares only about security (e.g. CISO briefing), drop this — it muddies the GHAS-vs-not-GHAS line. The 60-min agenda below skips it; the half-day agenda includes it as a 5-min interlude after lesson 3.
